define("pxseedServer2023/tjsentry", ["require", "exports", "partic2/jsutils1/base", "pxprpc/extend", "partic2/tjshelper/tjsenv", "pxprpc/base", "partic2/pxprpcClient/registry", "partic2/pxprpcBinding/utils", "partic2/tjshelper/jseiorpcserver", "partic2/tjshelper/httpprot", "partic2/tjshelper/tjsbuilder", "partic2/jsutils1/webutils", "./pxseedhttpserver"], function (require, exports, base_1, extend_1, tjsenv_1, base_2, registry_1, utils_1, jseiorpcserver_1, httpprot_1, tjsbuilder_1, webutils_1, pxseedhttpserver) {
    "use strict";
    ...
    async function getLoaderInfo() {
        let __v1 = await (0, utils_1.getRpcFunctionOn)(exports.pxprpcRuntimeBridgeClient, 'pxprpc_PxseedLoader.getLoaderInfo', '->b');
