define(["require", "exports", "preact", "./Inspector", "partic2/jsutils1/base", "partic2/pComponentUi/utils", "partic2/jsutils1/webutils", "./jsutils2", "./CodeContext"], function (require, exports, React, Inspector_1, base_1, utils_1, webutils_1, jsutils2_1, CodeContext_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.__inited__ = exports.PredefinedCodeContextViewerContext = exports.ImageViewer = exports.PredefinedCodeContextViewer = exports.HtmlViewer = exports.ObjectViewer = exports.css1 = exports.CustomViewerFactoryProp = void 0;
    exports.createViewableHtml = createViewableHtml;
    exports.createPredefinedCodeContextViewer = createPredefinedCodeContextViewer;
    ...
    exports.PredefinedCodeContextViewerContext = React.createContext({ codeContext: new CodeContext_1.LocalRunCodeContext() });
    ...
    function createPredefinedCodeContextViewer(source) {
        return {
            [exports.CustomViewerFactoryProp]: __name__ + '.PredefinedCodeContextViewer',
            ...source
        };
    }
    ...
    exports.__inited__ = (async () => {
        if (globalThis.document != undefined) {
            let { ReactRefEx } = await new Promise((resolve_1, reject_1) => { require(['partic2/pComponentUi/domui'], resolve_1, reject_1); });
                ...
                async onDisplayModelChanged() {
                    try {
                        ...
                        if (typeof robj === 'object' && robj != null && exports.CustomViewerFactoryProp in robj) {
                            ...
                            let mod = await new Promise((resolve_2, reject_2) => { require([viewerPath.substring(0, dotAt)], resolve_2, reject_2); });
                        ...
                        return React.createElement("div", null,
                            ...
                            (!this.state.folded) ?
                                React.createElement("div", { style: { paddingLeft: '1em' } }, robj.map((v1, i1) => {
                                    return React.createElement(exports.ObjectViewer, { name: String(i1), object: v1, key: 'index' + i1 });
                                })) : null);
                    }
                        ...
                        return React.createElement("div", null,
                            ...
                            (!this.state.folded) ?
                                React.createElement("div", { style: { paddingLeft: '1em' } }, keys.map((v1) => {
                                    return React.createElement(ObjectViewerImpl, { name: v1, object: robj[v1], key: 'index' + v1 });
                                })) : null);
                    }
                }
            }
            exports.ObjectViewer = ObjectViewerImpl;
            class HtmlViewerImpl extends React.Component {
                constructor() {
                    super(...arguments);
                    this.divRef = new ReactRefEx();
                }
                render(props, state, context) {
                    ...
                    if (this.props.object.html != undefined) {
                        return React.createElement("div", null,
                            React.createElement("div", { className: exports.css1.propName },
                                this.props.name,
                                ":"),
                            React.createElement("div", { dangerouslySetInnerHTML: { __html: this.props.object.html }, ref: this.divRef }));
                    }
                    else {
            ...
            exports.HtmlViewer = HtmlViewerImpl;
            class PredefinedCodeContextViewerImpl extends React.Component {
                constructor(props, ctx) {
                    super(props, ctx);
                    this.divRef = new ReactRefEx();
                }
                render(props, state, context) {
                    return React.createElement(exports.PredefinedCodeContextViewerContext.Consumer, null, value => {
                        if (this.props.object.js != undefined) {
                        ...
                        return React.createElement("div", null,
                            React.createElement("div", { className: exports.css1.propName },
                                this.props.name,
                                ":"),
                            React.createElement("div", { ref: this.divRef }));
                    });
                }
            }
            exports.PredefinedCodeContextViewer = PredefinedCodeContextViewerImpl;
            class ImageViewerImpl extends React.Component {
                render(props, state, context) {
            ...
            exports.ImageViewer = ImageViewerImpl;
        }
    })();
});
