define(["require", "exports", "preact", "partic2/pComponentUi/domui", "partic2/CodeRunner/RemoteCodeContext", "partic2/pxprpcClient/registry", "partic2/jsutils1/base", "partic2/jsutils1/webutils", "partic2/pComponentUi/input", "partic2/pComponentUi/window", "partic2/CodeRunner/CodeContext", "partic2/JsNotebook/workspace", "partic2/pComponentUi/texteditor"], function (require, exports, React, domui_1, RemoteCodeContext_1, registry_1, base_1, webutils_1, input_1, window_1, CodeContext_1, workspace_1, texteditor_1) {
    "use strict";
        ...
        render(props, state, context) {
            return [
                React.createElement("div", { className: domui_1.css.flexColumn },
                    ...
                    React.createElement("div", { style: { flexGrow: 1 } }, this.state.packageList.map(pkg => {
                        let cmd = [];
                        ...
                        if (pkg.options != undefined && registryModuleName in pkg.options) {
                            ...
                            if (opt.webui != undefined) {
                                cmd.push({ label: i18n.webui, click: () => {
                                        window.open((0, webutils_1.BuildUrlFromJsEntryModule)(opt.webui.entry), '_blank');
                                    } });
                            }
                        }
