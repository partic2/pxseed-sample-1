define("partic2/tjshelper/jseiorpcserver", ["require", "exports", "pxprpc/extend", "./tjsbuilder", "partic2/jsutils1/webutils"], function (require, exports, extend_1, tjsbuilder_1, webutils_1) {
    "use strict";
    ...
    exports.inited = (async function () {
        ...
        extend_1.defaultFuncMap['JseHelper.JseIo.chmod'] = new extend_1.RpcExtendServerCallable(async (path, mode) => {
