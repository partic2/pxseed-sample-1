define(["require", "exports", "partic2/jsutils1/base", "partic2/jsutils1/webutils", "pxprpc/backend", "pxprpc/base", "pxprpc/extend"], function (require, exports, base_1, webutils_1, backend_1, base_2, extend_1) {
    ...
    exports.persistent = exports.ServiceWorker = exports.ServerHostWorker1RpcName = exports.ServerHostRpcName = exports.IoOverPxprpc = exports.ClientInfo = exports.RpcWorker = exports.rpcWorkerInitModule = exports.__name__ = void 0;
    ...
    async function dropClient(name) {
        let clie = registered.get(name);
        if (clie != undefined) {
            clie.disconnect();
    ...
    async function addBuiltinClient() {
        if (globalThis.location != undefined && globalThis.WebSocket != undefined) {
            if (getRegistered(exports.ServerHostRpcName) == null) {
                ...
                addClient(pxprpcUrl, exports.ServerHostRpcName);
            }
