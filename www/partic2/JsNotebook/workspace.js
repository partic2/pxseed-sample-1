define("partic2/JsNotebook/workspace", ["require", "exports", "partic2/pComponentUi/domui", "preact", "./filebrowser", "partic2/pComponentUi/workspace", "partic2/pxprpcClient/registry", "./notebook", "./fileviewer", "partic2/CodeRunner/JsEnviron", "partic2/tjshelper/tjsonjserpc", "partic2/jsutils1/webutils", "partic2/CodeRunner/jsutils2", "./workerinit", "partic2/pComponentUi/input", "partic2/pComponentUi/window", "partic2/jsutils1/base", "partic2/CodeRunner/CodeContext", "./workerinit"], function (require, exports, domui_1, React, filebrowser_1, workspace_1, registry_1, notebook_1, fileviewer_1, JsEnviron_1, tjsonjserpc_1, webutils_1, jsutils2_1, workerinit_1, input_1, window_1, base_1, CodeContext_1) {
    "use strict";
    ...
    class WorkspaceContext {
        constructor(rpc) {
            ...
            this.fileBrowserFactory = (p) => {
                const Fb = filebrowser_1.__internal__.WorkspaceFileBrowser;
                return React.createElement(Fb, { ref: p.ref, fs: p.context.fs, context: p.context });
            };
        ...
        async start() {
            ...
            this.rootFileBrowser.windowHandler = await (0, workspace_1.openNewWindow)(this.fileBrowserFactory({ context: this, ref: this.rootFileBrowser.rref }), { title: this.title + ' File Browser', layoutHint: __name__ + '.FileBrowser' });
...
console.info(Array.from(jsutils2.u8hexconv(u8)))`,
    ...
    async function openJSNotebookFirstProfileWorkspace(opt) {
        class NotebookOnlyFileBrowser extends filebrowser_1.__internal__.WorkspaceFileBrowser {
            async DoNew() {
        ...
        workspace.fileBrowserFactory = (p) => {
            return React.createElement(NotebookOnlyFileBrowser, { ref: p.ref, fs: p.context.fs, context: p.context });
        };
