define(["require", "exports", "partic2/CodeRunner/CodeContext", "partic2/CodeRunner/WebUi", "partic2/jsutils1/base", "preact", "partic2/pxprpcClient/registry", "partic2/CodeRunner/JsEnviron", "partic2/pComponentUi/workspace", "./fileviewer", "partic2/CodeRunner/RemoteCodeContext", "partic2/pComponentUi/domui", "partic2/pxprpcClient/ui", "partic2/CodeRunner/RemoteCodeContext", "./misclib", "partic2/pComponentUi/window"], function (require, exports, CodeContext_1, WebUi_1, base_1, React, registry_1, JsEnviron_1, workspace_1, fileviewer_1, RemoteCodeContext_1, domui_1, ui_1, RemoteCodeContext_2, misclib_1, window_1) {
    ...
    class RunCodeView extends React.Component {
        constructor() {
            super(...arguments);
            this.valueCollection = new domui_1.ReactInputValueCollection();
            this.actionBar = new domui_1.ReactRefEx();
            this.rref = {
                selectContext: React.createRef(),
        ...
        render(props, state, context) {
            return React.createElement("div", { style: { width: '100%', overflow: 'auto' }, onKeyDown: (ev) => this.onKeyDown(ev) },
                React.createElement("div", null,
                    React.createElement("a", { href: "javascript:;", onClick: () => this.rref.selectContext.current?.active() },
                        "Code Context:",
                ...
                (this.props.tab.codeContext != undefined) ?
                    ...
                    'No CodeContext',
                React.createElement(window_1.WindowComponent, { ref: this.rref.selectContext, title: "select context" },
                    React.createElement("div", { className: domui_1.css.simpleCard },
                        React.createElement("div", null,
                            "From builtin",
                            React.createElement("br", null),
                            React.createElement("a", { href: "javascript:;", onClick: () => this.props.tab.useCodeContext('local window') }, "Local Window"),
                            "\u2003\u2003"),
                        React.createElement("div", null,
                            "From RPC",
                            React.createElement("br", null),
                            React.createElement(ui_1.RegistryUI, { onSelectConfirm: (client) => this.props.tab.useCodeContext(client) })),
                        React.createElement("div", null,
                            "From RunCodeContext registry",
                            React.createElement("br", null),
                            CodeContext_1.registry.list().map(name => React.createElement("a", { href: "javascript:;", onClick: () => this.props.tab.useCodeContext(CodeContext_1.registry.get(name)) }, name))))));
        }
    }
