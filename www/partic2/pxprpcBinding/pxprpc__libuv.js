define("partic2/pxprpcBinding/pxprpc__libuv", ["require", "exports", "./utils", "pxprpc/base", "./rpcregistry"], function (require, exports, utils_1, base_1, rpcregistry_1) {
    "use strict";
    ...
    class Invoker {
        ...
        async ensureFunc(name, typedecl) {
            return await (0, utils_1.getRpcFunctionOn)(this.rpc__client, this.RemoteName + '.' + name, typedecl);
        }
